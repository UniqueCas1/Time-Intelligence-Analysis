...
During the exploratory data analysis phase, we conducted a thorough examination of the dataset, including:
- Data cleaning and preprocessing by handling missing values, duplicate data entries and outliers, using MS Excel and power query on MS Power BI.
- Visualization of key metrics over time to identify trends using MS Power BI.
- Correlation analysis to determine relationships between variables.

## Key Data Questions Answered
The report was designed to answer two key stakeholder questions:
...
2. **How does seasonality affect our service usage?**  
   - *Answer:* Seasonality was observed, with increased usage during the holiday season, impacting staffing and resource allocation.
...
This suggests: More promotions ≠ More profit.

2. Margin Inefficiency Problem/ Over-discounting

Profit margin is healthy at 57.68% overall.
BUT: "High-engagement promotions did not translate proportionally into profit"
This indicates: Promotional campaigns are eroding margins even when driving engagement

3. Physical stores remain the dominant sales channel, while online sales show untapped growth potential, highlighting an opportunity for strategic channel rebalancing.
  
4. Revenue volatility across the year.

5. The Real Issue: Discount Fatigue

Discount strategies are be hurting long-term margin.
The data shows that constant discounting may be training customers to expect deals. When promotions are everywhere, their effectiveness diminishes. Customers may wait for discounts instead of buying at full price. This compounds year-over-year as customers become more price-sensitive.

How This Affects Your Year-on-Year Performance:
39% YoY growth is impressive, but the question is: Could it have been even higher with a different promotion strategy?
